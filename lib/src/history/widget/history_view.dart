                                                                    ...
                                                                    children: [
                                                                      SizedBox(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          )}. Sedang berkunjung selama ${time.inDays == 0 ? '' : time.inDays.toString().replaceAll('-', '')}${time.inDays != 0 ? 'hari ' : ''}${time.inHours == 0 || time.inHours <= -24 ? '' : time.inHours.toString().replaceAll('-', '')}${time.inHours != 0 ? ' jam' : ''} ${time.inMinutes <= -60 ? '' : time.inMinutes.toString().replaceAll('-', '')} ${time.inMinutes <= -60 ? '' : 'menit'}",
                                                                          maxLines:
                                                                              4,
                                                                        ),
                                                                      ),
